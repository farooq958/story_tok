...
import 'package:storily/components/app_text_style.dart';
...
class TextFormFieldWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return textFormField(
      ...
      textStyle: textStyle,
      hintStyle: hintStyle ??
          AppTextStyle.normalRegular12.copyWith(color: Colors.grey),
      borderColor: borderColor,
      filledColor: filledColor,
    );
  }
...
class SearchBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormFieldWidget(
      ...
      hintStyle: AppTextStyle.normalRegular14.copyWith(color: Colors.grey),

      prefixIcon: prefixIcon ??
          IconButton(
            icon: Image.asset("assets/images/svg/search.svg"),
            splashRadius: 5,
            onPressed: onSubmit,
          ),
  ...
  return Column(
    ...
    children: [
      ...
      TextFormField(
        ...
        cursorHeight: 14,
        style: textStyle ??
            AppTextStyle.normalRegular14.copyWith(fontWeight: FontWeight.w500),
        decoration: InputDecoration(
          ...
          errorMaxLines: 1,
          fillColor: filledColor ?? Colors.grey.withOpacity(0.60),
          filled: true,
          hintStyle: hintStyle ??
...
OutlineInputBorder outlineBorderDecoration = OutlineInputBorder(
