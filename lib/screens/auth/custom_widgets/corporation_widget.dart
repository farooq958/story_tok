...
class CorporationWidget extends StatefulWidget {
  CorporationWidget({Key? key, this.authorImageFile}) : super(key: key);
                ...
                children: [
                  ...
                  TextFormField(
                    controller: authController.corporateFielsList[index]
                        ["textController"],
                    validator: authController.corporateFielsList[index]
                        ["Validatior"],
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      TextFormField(
                        ...
                        keyboardType: TextInputType.number,
                        validator: (value) =>
                            Validators.validateDigits(value!, "PostalCode", 6),
                        maxLength: 6,
                        autovalidateMode: AutovalidateMode.onUserInteraction,
                        decoration: InputDecoration(
                          counterText: "",
            ...
            onTap: () async {
              if (corporationKey.currentState!.validate()) {
                if (authController.selectedCountryName.value == null &&
                  ...
                  Get.snackbar(
                    "Required",
                    "country is required, Please select first.",
                  );
                } else if (widget.authorImageFile == null) {
                  Get.snackbar(
                    "Required",
                    "Image is required, Please select first.",
                  );
                } else {
