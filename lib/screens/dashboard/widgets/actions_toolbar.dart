    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _getSocialAction(icon: FeedIcons.heart, title: numLikes),
          _getSocialAction(icon: FeedIcons.chat_bubble, title: numComments),
          _getSocialAction(
              icon: FeedIcons.reply, title: 'Share', isShare: true),
